...
var TabPanelComponent = (function(_Component) {
  ...
  function TabPanelComponent() {
    ...
    return _possibleConstructorReturn(
      this,
      (
        TabPanelComponent.__proto__ || Object.getPrototypeOf(TabPanelComponent)
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _extends({}, props, {
            ...
            hidden: !selected,
            className: "rwt__tabpanel__menu " + (className || "")
          }),
          component
            ? _react2.default.createElement(component, childProps)
            : render
            ? render(childProps)
            : children
            ? children
